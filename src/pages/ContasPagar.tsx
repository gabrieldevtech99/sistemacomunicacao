...
import { useContasPagar, ContaPagarInput, StatusConta } from "@/hooks/useContasPagar";
...
export default function ContasPagar() {
  const { contas, isLoading, createConta, marcarComoPago, deleteConta } = useContasPagar(false);
  ...
  const [form, setForm] = useState<ContaPagarInput>({
    descricao: "",
    valor: 0,
    ...
    <MainLayout>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Gerencie suas contas e despesas</p>
        </div>
